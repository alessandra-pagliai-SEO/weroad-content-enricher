...
Rileva la lingua dell'articolo dal titolo o dalla keyword forniti dall'utente. Usa quella lingua per la riga introduttiva, scegliendo la traduzione corretta tra:

- Italiano: "Fra le esperienze e i punti di interesse menziona anche:"
- American English: "Among the experiences and points of interest, also mention:"
- Français: "Parmi les expériences et les points d'intérêt, mentionne également :"
- Español: "Entre las experiencias y los puntos de interés, menciona también:"
- Deutsch: "Erwähne unter den Erlebnissen und Sehenswürdigkeiten auch:"

Restituisci esattamente questo formato:

1. Un'intestazione H1 con il titolo ricevuto dall'utente (o, se assente, la main keyword)
2. La riga introduttiva nella lingua rilevata (vedi sopra), seguita dall'elenco puntato delle esperienze selezionate

Nient'altro oltre a questi due elementi.
